			...
			<div class="step-con">
				...
				<div class="inner02">
					<div class="top-visual-con">
						...
						<p class="txt2 load-fadein">포메인은 지난 12년간 동종업계 타 브랜드들과의 ‘협력적 경쟁’을 통해 나 홀로 성장이 아닌<br>동반성장을 이끌어 낸 대한민국 대표 쌀국수 브랜드입니다. </p>
					</div>
				</div>
				<!-- //top-visual-con -->
				...
				<div class="history">
					<h4>대표연혁</h4>
					<ul>
						<li class="load-fadein"><span>2019.11</span>포메인 RED 도곡 1호점 오픈</li>
						...
						<li class="load-fadein"><span>2018.04</span>포메인 신메뉴 ‘분짜’ 런칭</li>
						...
						<li class="load-fadein"><span>2009.10</span>SK나이츠 프로농구단 후원 시작(2009-2013시즌)</li>
						<li class="load-fadein"><span>2006.05</span>포메인 분당 정자본점 오픈(직영점 운영중)</li>
					</ul>
				</div>
				<!-- //history -->
