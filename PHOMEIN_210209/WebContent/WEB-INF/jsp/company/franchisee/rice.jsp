...
.red02-wrap .box li{box-shadow: 0px 11px 12.87px 0.13px rgba(0, 0, 0, 0.3); text-align: center; padding: 100px 90px; width: 29%; font-size: 22px; font-weight: lighter; background-color: #fff; box-sizing: border-box; display: inline-block; box-sizing: border-box; margin-left: 3.333333%;}
